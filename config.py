...
class Config(object):
    ...
    # database config
    DB_NAME = os.environ.get("DB_NAME","VJ_Botz")     
    DB_URL  = os.environ.get("DB_URL","mongodb+srv://ajmerasaini01:U1sGiZRI6Ha0xuCy@cluster0.tnok3d0.mongodb.net/")
    PORT = os.environ.get("PORT", "8050")
    OWNER = int(os.environ.get("OWNER", "8413546109"))
    ...
    DUMB_CHANNEL = os.environ.get("DUMB_CHANNEL", "-1003161993313")
